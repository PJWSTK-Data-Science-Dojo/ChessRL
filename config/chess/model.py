...
class ChessNet(EfficientZeroNet):
    def __init__(self, obs_shape, action_space_size, **kwargs):
        super(ChessNet, self).__init__(obs_shape, action_space_size, **kwargs)
        # Dodatkowe modyfikacje dla szachów jeśli potrzebne
        # np. dostosowanie liczby filtrów konwolucyjnych
