...
inference/training enabled. The replay capacity counts positions, not trajectories.
Reanalysis starts after 40,000 optimizer steps so the initial dynamics model does not
immediately rewrite targets generated by an equally immature network.
